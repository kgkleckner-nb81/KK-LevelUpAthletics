...
const sampleMedia={
  'Push-ups':{instructionText:'Hands under shoulders, body in one straight line from head to heels. Squeeze your core and butt tight, lower your chest almost to the floor, elbows at about a 45° angle, then push back up.',formCues:[],commonFaults:['Don’t let your hips sag or pike up in the air — that’s cheating your core and can tweak your lower back.']},
  'Wide Push-ups':{instructionText:'Same as a push-up, just set your hands out wider than shoulder-width. Keep that same straight-line body and control the lowering — don’t just drop.',formCues:[],commonFaults:['Don’t flare your elbows all the way out to 90° — a slight bend angle protects your shoulders.']},
  'Squats':{instructionText:'Feet shoulder-width, toes turned slightly out. Sit your hips back and down like you’re sitting in a chair. Chest up, knees tracking over your toes, go as low as you can control.',formCues:[],commonFaults:['Don’t let your knees cave inward — keep them pushed out in line with your feet the whole time.']},
  'Jump Squats':{instructionText:'Squat down like normal, then explode straight up as high as you can. Land soft with bent knees and reset right into the next rep.',formCues:[],commonFaults:['Don’t land stiff-legged — always land quiet and soft to protect your knees and ankles.']},
  'Glute Bridge':{instructionText:'Lie on your back, knees bent, feet flat on the floor. Squeeze your glutes and lift your hips up until your body’s a straight line from shoulders to knees.',formCues:[],commonFaults:['Don’t overarch your lower back to get higher — squeeze your butt to lift, not your spine.']},
  ...
  'Bird Dog':{instructionText:'On hands and knees, extend one arm and the opposite leg straight out, hips staying level, hold briefly, then switch.',formCues:[],commonFaults:['Don’t let your hips twist or rotate open — keep them square to the floor the whole time.']},
  ...
  '10-yard Sprint':{instructionText:'Start in an athletic stance, drive your first steps low and hard, pump your arms, sprint all the way through the line.',formCues:[],commonFaults:['Don’t stand straight up right away — popping up too early kills your acceleration.']},
  ...
  'Hill Sprint':{instructionText:'Find a moderate hill, lean into the incline a bit, drive your knees up and pump your arms hard to the top.',formCues:[],commonFaults:['Don’t sprint back down the hill for "extra reps" — that’s exactly how ankles get rolled. Walk back down.']},
  ...
  'Lateral Shuffle':{instructionText:'Athletic stance, stay low, shuffle side to side without ever crossing your feet.',formCues:[],commonFaults:['Don’t stand up tall while shuffling — staying low the whole time is what makes this drill actually work.']},
  ...
  'Vertical Jump':{instructionText:'Quick dip down, swing your arms up hard, jump straight up as high as you can.',formCues:[],commonFaults:['Don’t skip the landing — always absorb it through bent knees instead of just crashing down straight-legged.']},
  'Single-Leg Hops':{instructionText:'Balance on one leg, hop forward or in place with small, controlled hops, landing soft on that same leg each time.',formCues:[],commonFaults:['Don’t push through these if your balance feels shaky that day — do fewer reps and build up over time.']},
  ...
  'Box Jump':{instructionText:'Face a sturdy box that’s an appropriate height for you, swing your arms, and jump up landing with both feet fully on top, knees soft.',formCues:[],commonFaults:['Don’t jump onto a box too high to land on with full control — and always step back down, never jump down off the box.']},
  'Tuck Jump':{instructionText:'Jump straight up and pull both knees up toward your chest, landing soft and quiet.',formCues:[],commonFaults:['Don’t lean way forward or backward in the air — stay tall and controlled.']},
  'Jump Rope':{instructionText:'Small hops, just enough to clear the rope, elbows in close to your body, wrists doing the turning.',formCues:[],commonFaults:['Don’t jump way too high off the ground — big jumps throw off your rhythm and gas you out fast.']},
  'Pogo Jumps':{instructionText:'Quick, small, springy hops using mostly your ankles, like a pogo stick — barely bend your knees.',formCues:[],commonFaults:['Don’t turn these into big bounding jumps — keep it quick, small, and low to the ground.']},
  'Single-Leg Balance':{instructionText:'Stand on one leg, other knee lifted, pick a spot to focus your eyes on, and hold steady.',formCues:[],commonFaults:['Don’t lock your standing knee out stiff — keep a soft bend so you can actually adjust and balance.']},
  'Single-Leg Reach':{instructionText:'Balance on one leg, hinge forward at your hips and reach the opposite hand toward the ground, keeping your back flat, then return to standing.',formCues:[],commonFaults:['Don’t round your back to reach farther — the bend comes from your hips, not your spine.']},
  ...
  'Mountain Climbers':{instructionText:'Start in a plank/push-up position, drive your knees alternately toward your chest quickly, core tight, hips level.',formCues:[],commonFaults:['Don’t let your hips bounce up and down — keep them level like a plank the entire time.']},
  'Hip Mobility':{instructionText:'Flow through moves like 90/90 switches and lateral lunges, moving slow and controlled to open up your hips.',formCues:[],commonFaults:['Don’t bounce or force a stretch — ease into your range, never yank or jerk into it.']},
  ...
  'Deep Squat Hold':{instructionText:'Sink down into the lowest comfortable squat position, chest up, and just hang out there and breathe.',formCues:[],commonFaults:['Don’t force your heels flat to the floor if they want to pop up — that improves gradually on its own, don’t force it.']},
